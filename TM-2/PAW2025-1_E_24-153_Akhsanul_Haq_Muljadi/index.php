...
<body>
	<?php if ($showForm): ?>
		...
		<form method="POST">
			...
			<fieldset>
				...
				<input type="text" name="email" value="<?= $saveEmail ?>" placeholder="input sesuai ketentuan email example:akhsanulhaq@gmail.com">
			...
			<fieldset>
				...
				<input type="text" name="noSertifikat" value="<?= $saveSertifikat ?>" placeholder="input dengan numeric dan sesuai format. Example: 12.12.12.12.1.12345">
	...
	<?php else: ?>
		<div class="success-box">
			<p class="success-message">Data transaksi tanah berhasil!</p>
		</div>
	<?php endif; ?>
</body>
